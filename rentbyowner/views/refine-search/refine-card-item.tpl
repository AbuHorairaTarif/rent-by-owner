              ...
              <div class="col">
                <div class="card h-90 shadow">
                  <div class="img-card">
                      ...
                      <img src="static/img/img1.jpg" class="card-img-top"
                      alt="Hollywood Sign on The Hill" />
                      <button type="button" class="btn btn-light btn-money">From <i class="fa-solid fa-dollar-sign"></i> 9,181</button>
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">
                     ...
                     <a href="/property"><h6 class="card-title">Two bedroom apartment, close to Ctg airport</h6></a> 
                      ...
                      <small><a href="#" class="location-text">Chittagong Division > Chittagong</a></small>
